...
class OneStepOraclePolicy(BaseCATPolicy):
    name = "OneStepOracle"
    metadata = PolicyMetadata(name=name, implementation="one_step_query_nll_upper_bound", uses_privileged_information=True, notes="Uses logged candidate responses and query labels for one-step lookahead upper bound.")

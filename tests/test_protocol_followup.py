...
def test_policy_step_zero_with_history_len_one(tmp_path, monkeypatch):
    ...
    torch.save({'actor_state_dict':MIRTActor().state_dict(),'action_mean':torch.zeros(37),'action_std':torch.ones(37),'hidden_dim':128,'actor_architecture':ACTOR_ARCHITECTURE,'theta_fit':theta,'selection_horizon':4,'warm_start_items':1}, ck)
    seen={}
